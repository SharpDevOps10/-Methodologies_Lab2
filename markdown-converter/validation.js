...
export const formattingRulesToHTML = {
  '(?<![\\w`*\u0400-\u04FF])\\*\\*(\\S(?:.*?\\S)?)\\*\\*(?![\\w`*\u0400-\u04FF])': '<b>$1</b>',
  '(?<![\\w`*\\u0400-\\u04FF])_(\\S(?:.*?\\S)?)_(?![\\w`*\\u0400-\\u04FF])': '<i>$1</i>',
  '(?<![\\w`*\\u0400-\\u04FF])`(\\S(?:.*?\\S)?)`(?![\\w`*\\u0400-\\u04FF])': '<tt>$1</tt>',
};

export const formattingRulesToANSI = {
  '(?<![\\w`*\u0400-\u04FF])\\*\\*(\\S(?:.*?\\S)?)\\*\\*(?![\\w`*\u0400-\u04FF])': '\x1b[1m$1\x1b[22m',
  '(?<![\\w`*\\u0400-\\u04FF])_(\\S(?:.*?\\S)?)_(?![\\w`*\\u0400-\\u04FF])': '\x1b[3m$1\x1b[23m',
  '(?<![\\w`*\\u0400-\\u04FF])`(\\S(?:.*?\\S)?)`(?![\\w`*\\u0400-\\u04FF])': '\x1b[7m$1\x1b[27m',
  '\\```(.*?)\\```': '\x1b[7m$1\x1b[27m',
};
